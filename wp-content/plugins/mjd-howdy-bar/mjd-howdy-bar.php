...
add_action( 'wp_footer', 'mjd_howdy_html' );

/**
 * Attach a stylesheet & a JS file
 */
function mjd_howdy_scripts(){
...
add_action( 'wp_enqueue_scripts', 'mjd_howdy_scripts' );
